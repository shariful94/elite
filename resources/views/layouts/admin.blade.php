	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="{{url('dashboard')}}"><span class="align-middle">gamm atsk</span></a>
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item {{ Request::is('tag') ? 'active' : '' }}">
						<a class="sidebar-link" href="{{url('tag')}}"><i class="align-middle" data-feather="at-sign"></i> <span class="align-middle">POS</span></a>
					</li>
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-light navbar-bg">
                ...
                <img src="{{url('assets/img/avatars/avatar.jpg')}}" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">shariful islam</span>
              </a>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="#" target="_blank"><strong>gamma</strong></a> - <a class="text-muted" href="#" target="_blank">&copy; {{date('Y');}} <strong>Blog Page</strong></a>
							</p>
						</div>
					</div>
				</div>
